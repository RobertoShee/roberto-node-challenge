...
export class TaskMapper {
  // Convierte entidad Task a DTO de respuesta
  ...
  // Convierte entidad Task a DTO de listado
  ...
  // Mapea enum público al tipo de entidad
  ...
  // Mapea tipo de entidad al enum público
